...
# tohle to je jeste verze kdy zobrazi normalni graficky okno a musi se kliknou na na tlacitko zavrit
# ale zobrazuje nakonec vlastne dve okna misto jednoho, takze nevim to starsi se mi vlastene libilo vic
