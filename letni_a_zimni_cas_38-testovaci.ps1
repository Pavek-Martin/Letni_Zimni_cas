...
Remove-Variable usek_roku, pole_file_historie_ulozit, pole_file_historie_nacteno -ErrorAction SilentlyContinue
...
# je posleni nedele v breznu ale je mene nezli 02:00:00 hodin
echo "usek 1-B"
$usek_roku = 1
# usek = 2 ?
...
# tady pozor, systemovi cas se zde vrati o hodinu spatky, takze pri dalsim spusteni by program na zaklade jiz upraveneho
...
# a v historii je usek roku cislo 3 a aktualni je cislo 2 ( predchozi elseif ) tak - nedelej nic 
# toto plati pouze hodinu vlastne,jenom do te doby nez plynouci systemovi cas zase o hodinu "dobehne" podminu :)
echo "usek 3-A"
$usek_roku = 3
...
echo "usek 3-B"
$usek_roku = 3
# tady se uz pak neresi se presupnej rok tzn. 365 nebo 366 dni v roce
...
# soubor historie jiz existuje, nacti znej udaje a prirad je promenym
...
$zapis_historii = 0
# bude zapisovat jenom kdyz je potreba, tzn. v pripade zmen a nebude se zapisouvat 2x totez
$cas_plus_hodina = 0
$cas_minus_hodina = 0
