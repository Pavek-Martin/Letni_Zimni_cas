...
$posledni_nedele_v_breznu = $pocet_dnu_v_mesici - $den_v_tydnu
echo "nedele $posledni_nedele_v_breznu.$mesic.$rok"


$mesic = 10
$pocet_dnu_v_mesici = $pole_delka_mesice[$mesic -1]
$den_v_tydnu = Get-DayOfWeek $rok $mesic $pocet_dnu_v_mesici
$posledni_nedele_v_rijnu = $pocet_dnu_v_mesici - $den_v_tydnu
echo "nedele $posledni_nedele_v_rijnu.$mesic.$rok"
