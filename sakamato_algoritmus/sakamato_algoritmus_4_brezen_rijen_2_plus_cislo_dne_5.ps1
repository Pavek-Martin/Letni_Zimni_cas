...
[int32] $letos_rok = (get-date).Year
#echo $rok # int32
#$letos_rok = 2001 # testovaci radek
...
#echo "unor $letos_rok = $prestupny_rok dnu" # prstupny rok ?
...
echo "nedele $posledni_nedele_v_breznu.$mesic_1.$letos_rok cislo dne je $cislo_dne_brezen"
...
echo "nedele $posledni_nedele_v_rijnu.$mesic_2.$letos_rok cislo dne je $cislo_dne_rijen"
